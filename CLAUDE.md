...
- Les laptimes ne sont plus intégré par XmlDataService avec processXmlFile, mais par reception des données sur la route POST /api/laptimes provenant du livetiming.
